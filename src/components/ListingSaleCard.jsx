  ...
  <div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col w-80">
    ...
    <div className="p-4 pb-2 flex flex-col flex-1">
      <div className="flex items-center gap-2 mb-1">
        ...
        <div>
          <div className="font-bold text-lg text-white drop-shadow-sm">{name}</div>
          <div className="text-sm text-white/90">{address}</div>
        </div>
      </div>
    </div>
    {/* Détails */}
    <div className="flex justify-between items-center px-4 py-2 border-t text-gray-700 text-sm">
