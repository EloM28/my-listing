    ...
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="relative w-full md:w-auto" ref={sortRef}>
          <button
            className="flex items-center justify-between w-56 md:w-56 px-4 py-2 border-b border-gray-200 font-normal text-gray-900 bg-white focus:outline-none"
          ...
          {sortOpen && (
            <div className="absolute right-0 mt-2 w-56 left-0 md:w-56 bg-white rounded shadow-lg border border-gray-100 z-30 animate-fade-in">
