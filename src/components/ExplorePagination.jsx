...
const ExplorePagination = ({ onMapClick, showMap }) => {
  return (
    <div className="flex items-center gap-4 w-full justify-between">
      ...
      <button
        className="ml-2 flex items-center justify-center w-10 h-10 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition focus:outline-none focus:ring-2 focus:ring-rose-400"
        onClick={onMapClick}
        aria-label={showMap ? "Voir la liste" : "Voir la carte"}
        type="button"
      >
        {showMap ? (
          // Icône liste
