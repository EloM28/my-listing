...
const AuthForm = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-white flex flex-col items-stretch">
      <div className="flex-1 flex flex-col items-start justify-start w-full max-w-md mx-auto p-8 mt-6">
        <div className="w-full bg-white rounded-lg shadow-lg relative flex flex-col px-6">
