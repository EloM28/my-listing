...
const listings = [
  {
    ...
    price: "$4,500",
    image: "wp-content/uploads/sites/7/2019/11/n2-2-768x524.jpg",
    area: "1250 sq ft",
    rooms: 4,
    bathrooms: 3,
    beds: 3,
  ...
  },
  {
    ...
    price: "$1,600",
    image: "wp-content/uploads/sites/7/2019/11/r2-2-768x512.jpg",
    area: "365 sq ft",
    rooms: 1,
    bathrooms: 1,
    beds: 1,
  ...
  },
  {
    ...
    price: "$1,900",
    image: "wp-content/uploads/sites/7/2019/11/n1-1-768x575.jpg",
    area: "1170 sq ft",
    rooms: 3,
    bathrooms: 2,
    beds: 2,
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
        {listings.map((item, idx) => (
          <div key={idx} className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col">
            ...
            {/* Infos */}
            <div className="flex justify-between px-6 py-4 border-b border-gray-100 text-gray-700 text-sm">
