...
const ProductDetail = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row gap-8 items-start">
      {/* Image */}
