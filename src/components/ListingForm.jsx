...
function ImageUpload({ label, multiple = false, onChange, value }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        className="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer bg-gray-50 hover:bg-gray-100 transition min-h-[120px] relative"
        onDrop={handleDrop}
        onDragOver={handleDragOver}
        onClick={() => inputRef.current.click()}
      >
        <svg className="w-10 h-10 text-gray-400 mb-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 15a4 4 0 004 4h10a4 4 0 004-4M7 15V7a4 4 0 018 0v8" /></svg>
        <span className="text-gray-500 text-sm">Glissez-déposez ou cliquez pour sélectionner des images</span>
        <input
          ref={inputRef}
          type="file"
          accept="image/*"
